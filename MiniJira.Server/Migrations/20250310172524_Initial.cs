    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", false, "Admin", false, null, "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAEAACcQAAAAEN/oK1hV6qGNa0gc2SCXUFnyeGIgrqBbST7p5Az/1QFPUAcVjp4yIUSBY/nt+y/rAA==", null, false, null, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Permission", "CreateIssue", 1 },
                    { 2, "Permission", "EditIssue", 1 },
                    { 3, "Permission", "ViewIssues", 1 },
                    { 4, "Permission", "CreateUser", 1 },
                    { 5, "Permission", "EditUser", 1 },
                    { 6, "Permission", "ViewUsers", 1 },
                    { 7, "Permission", "AddProject", 1 },
                    { 8, "Permission", "ViewProjects", 1 },
                    { 9, "Permission", "EditProject", 1 },
                    { 100, "Permission", "ViewIssues", 2 },
                    { 101, "Permission", "EditIssue", 2 },
                    { 102, "Permission", "ViewProjects", 2 },
                    { 200, "Permission", "CreateIssue", 3 },
                    { 201, "Permission", "ViewIssues", 3 },
                    { 202, "Permission", "EditIssue", 3 },
                    { 203, "Permission", "ViewProjects", 3 }
                });
